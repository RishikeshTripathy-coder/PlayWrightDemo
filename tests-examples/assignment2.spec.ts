...
const FirName = "Amol";
const LtName = "Gaikwad";
const TelePhone = "9123456789";
const Pass = "Amol123@#";
...
function modifyGmail(email) {
  ...
  var parts = email.split('@');
    if (parts.length !== 2 || parts[1] !== 'gmail.com') {
        console.log("Invalid Gmail. Please provide a valid Gmail.");
        return null;
    }
...
const originalEmail = 'abc123@gmail.com';
...
test('My Account Register', async ({ page }) => {
  ...
  const Warning = await page.locator("#input-agree");
